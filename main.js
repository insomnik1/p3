...
function attaquePOne(attack, target, attaquant) {
    ...
    if (randomize(0, attack.accuracy) == attack.accuracy) {
        ...
        console.log(attaquant.namePlayer + " Vous vous emmelez les pinceaux, attaque ratée !");
    }
    console.log("A l'issue de ce tour, vos pv restants sont de : " + target.namePlayer + target.pv);
...
return console.log("\ud83d\ude31 Fin de partie !!!! \ud83d\ude31" );
